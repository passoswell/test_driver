...
#ifndef DEV_SSD1306_HPP
#define DEV_SSD1306_HPP
...
{
public:
  DriverInOutBase *m_driver;
  uint8_t m_row = 0, m_column = 0;

  SSD1306(DriverInOutBase *port_handle, uint8_t address_8bits = SSE1306_0x3C);
  ~SSD1306();
