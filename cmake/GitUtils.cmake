...
function(git_clone)
    ...
    if(EXISTS ${${SOURCE_DIR}})
        ...
        if(NOT PARGS_QUIET)
            ...
            message("-- Using command: ${GIT_EXECUTABLE} clone ${PARGS_GIT_URL} --recursive ${${SOURCE_DIR}}")
            message("-- Working directory: ${PARGS_DIRECTORY}")
        endif()

        file(MAKE_DIRECTORY ${PARGS_DIRECTORY})
        execute_process(
